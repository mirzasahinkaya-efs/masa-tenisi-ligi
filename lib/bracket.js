...
// site and by the Slack bot, so an in-place edit in one consumer would corrupt
// bracket seeding in the other. A bare Object.freeze on the array would leave
// the four entries mutable.
export const PLAYOFF_FIXTURES = Object.freeze([
  Object.freeze({ id: 'SF1', stage: 'playoff', label: 'Semifinal 1', slotP1: 'A1', slotP2: 'B2' }),
  Object.freeze({ id: 'SF2', stage: 'playoff', label: 'Semifinal 2', slotP1: 'B1', slotP2: 'A2' }),
  Object.freeze({ id: 'FINAL', stage: 'playoff', label: 'Final', slotP1: 'W-SF1', slotP2: 'W-SF2' }),
  Object.freeze({ id: 'THIRD', stage: 'playoff', label: 'Third place', slotP1: 'L-SF1', slotP2: 'L-SF2' }),
]);
